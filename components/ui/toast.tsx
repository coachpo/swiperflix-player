...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed inset-x-0 bottom-[calc(16px+env(safe-area-inset-bottom))] z-[100] mx-auto flex max-h-[60vh] w-full max-w-sm flex-col gap-3 px-4 outline-none sm:right-4 sm:left-auto sm:bottom-6",
      className,
    )}
    {...props}
  />
